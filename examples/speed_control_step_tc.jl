# Example of using speed control with a step input for the set_speed using the TorqueControlledMachine
using Pkg
...
function simulate(t_sim=60; f_0=7300, speed_0=3.176, dt=1/set.sample_freq)
    ...
    for t in time
        ...
        acc = calc_acceleration(wm, v_ro, f; set_speed, use_brake = false)
        push!(ACC, acc)
